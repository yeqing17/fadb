...
pub fn text(language: Language, key: &str) -> &'static str {
    match (language, key) {
        ...
        (Language::Chinese, "assistant_attachment_lines") => "行",
        (Language::Chinese, "assistant_attachment_chars") => "字符",
        (Language::Chinese, "assistant_attachment_open") => "打开",
        (Language::Chinese, "assistant_long_input_hint") => "内容较长：发送时将自动保存为 txt 附件",
        ...
        (Language::Chinese, "logcat_copy_visible") => "复制可见内容",
        (Language::Chinese, "logcat_copy_selection") => "复制所选",
...
only for the current user."
        ...
        (_, "logcat_copy_visible") => "Copy visible",
        (_, "logcat_copy_selection") => "Copy selection",
...
access to device data until you grant it."
        ...
        (_, "assistant_attachment_lines") => "lines",
        (_, "assistant_attachment_chars") => "chars",
        (_, "assistant_attachment_open") => "Open",
        (_, "assistant_long_input_hint") => "Long content is saved as a .txt attachment on send",
...
mod tests {
    ...
    const ASSISTANT_KEYS: &[&str] = &[
        ...
        "assistant_send",
        "assistant_send_hint",
        "assistant_attachment_lines",
        "assistant_attachment_chars",
        "assistant_attachment_open",
        "assistant_long_input_hint",
        "ai_settings",
        "ai_endpoint",
        "ai_model_name",
        "ai_api_key",
